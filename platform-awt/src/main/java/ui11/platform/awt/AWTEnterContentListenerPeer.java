...
public class AWTEnterContentListenerPeer extends Widget {
    ...
    @Inject private AWTWindow window;
    @Inject private FocusRoot focusRoot;

    @Remember private AWTEnterContentListenerPeerState state;
    ...
    protected Widget build() {
        ...
        Observable.of(() -> focusRoot.isFocused(widget.focusHolder())).getAndSubscribe(focused -> {
            if (focused)
