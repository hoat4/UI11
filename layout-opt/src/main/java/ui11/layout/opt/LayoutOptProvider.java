...
public class LayoutOptProvider implements ResolverProvider {
    ...
    public void configure(ResolverRegistry r) {
        r.addPeerIndependentWithFilter(LinearLayoutOpt.CollapsedLLRequest.class,
                LinearLayout.class, LinearLayoutOpt.LLFinder::new);
        r.addTransformer(LinearLayout.class, LinearLayoutOpt.LLTransformer::new);
    }
}
