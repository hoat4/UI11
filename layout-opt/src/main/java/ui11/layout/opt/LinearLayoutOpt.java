...
class LinearLayoutOpt extends Widget {
    ...
    private final UnaryOperator<Widget> transformedWidgetRequest;

    @Inject private CollapsedLLRequest[] collapsedLLRequests;

    public LinearLayoutOpt(LinearLayout linearLayout, UnaryOperator<Widget> transformedWidgetRequest) {
