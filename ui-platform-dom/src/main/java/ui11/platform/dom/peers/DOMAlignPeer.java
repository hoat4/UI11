...
public class DOMAlignPeer extends DOMLayoutPeerBase {
    ...
    private static final String CLASS_CHILDREN_MAX_SIZE_IS_100PERCENT = "sm";
    ...
    protected List<? extends HTMLElement> children() {
        Widget alignedContent = alignedContentSlot.use(align.content());
        Widget alignedContentWithCSSClass = align.allowExpandOutside() ?
                ...
                alignedContent;
        HTMLElement child = wrappedContentSlot.instantiate(
                new DOMWidgetWrapper(alignedContentWithCSSClass)).lookup(DOMElementHolder.class).element();
        ...
        if (align.allowExpandOutside()) {
            ...
            // viszont lehet hogy LL-nél is kéne valami
