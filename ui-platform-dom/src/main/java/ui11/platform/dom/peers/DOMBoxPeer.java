...
public class DOMBoxPeer extends DOMPeerBase<HTMLElement> {
    ...
    protected void update() {
        DOMElementHolder childPeer = contentSlot.instantiate(new DOMWidgetWrapper(box.content())).
                lookup(DOMElementHolder.class);
        DOMElementHolder bgPeer = box.background() == null ? null : backgroundSlot.instantiate(
                        new DOMWidgetWrapper(cssClass(CLASS_POSITION_ABSOLUTE, CLASS_Z_ZERO, box.background()))).
                lookup(DOMElementHolder.class);
        DOMElementHolder borderFillPeer = box.border() == null ||
                box.border().thickness().isZero() ? null :
                borderFillSlot.instantiate(new DOMWidgetWrapper(box.border().fill())).
                        lookup(DOMElementHolder.class);
