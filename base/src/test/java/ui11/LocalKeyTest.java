...
public class LocalKeyTest extends Widget {
    ...
    public static void main() throws InterruptedException {
        ...
        Window.open(new LocalKeyTest(reverse));
        Thread.sleep(5000);
    ...
    LocalKeyTest(Observable<Boolean> reverse) {
    ...
    private Widget fa() {
        return new ElementIdentityPrintingWidget().withKey(Key.of("A"));
    }

    private Widget fb() {
        return new ElementIdentityPrintingWidget().withKey(Key.of("B"));
    }
