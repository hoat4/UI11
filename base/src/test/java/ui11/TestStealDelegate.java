...
public class TestStealDelegate {
    public void main() {
        ...
        WidgetTree.create(new Component() {
            ...
            protected void update() {
                ...
                Widget w2 = withID("w2", new W2(w1));
                useComponent(withID("outer1", new T(w2)));
                useComponent(withID("outer2", new T(w1)));
                useComponent(withID("outer3", new T(w2)));
            }
        }, Runnable::run);
    }
    ...
    private static class T extends Widget {
        ...
        protected Widget build() {
            return ExposeRequest.requestSingle(w, UV.UVRequest.INSTANCE, result->{
    ...
    static class UV extends SubstitutedWidget {
        ...
        static class UVRequest extends ExposeRequest<UV> {
